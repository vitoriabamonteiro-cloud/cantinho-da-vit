...
function LoginScreen({ onLogin }) {
  ...
  const handleGoogleLogin = async () => {
    ...
    try {
      ...
      // página vai redirecionar — o resultado volta no getRedirectResult acima
    } catch (e) { console.error(e); setError("Erro ao iniciar login. Tente novamente."); setLoading(false); }
  };
  return (
...
export default function App() {
  ...
  useEffect(() => {
    // Captura token do Google Calendar após voltar do redirect
